...
export function NotFoundPage() {
  ...
  return (
    <div className="mx-auto flex max-w-md flex-col items-center pt-24 text-center">
      ...
      <h1 className="mt-4 text-xl font-semibold text-neutral-100">Page not found</h1>
      <p className="mt-1 text-sm text-neutral-400">The page you're looking for doesn't exist or has moved.</p>
